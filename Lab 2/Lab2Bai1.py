...
sv1 = SinhVien(2100011, "Nguyen Doan Trang", datetime.strptime("01/01/2000","%d/%m/%Y"))
sv2 = SinhVien(2111904, "Nguyen Van Nam", datetime.strptime("11/11/2001","%d/%m/%Y"))
sv3 = SinhVien(2111905, "Nguyen Pham A", datetime.strptime("12/12/2002","%d/%m/%Y"))
sv4 = SinhVien(2111906, "Nguyen Tran B", datetime.strptime("10/10/2003","%d/%m/%Y"))
sv5 = SinhVien(2111111, "Sinh Vien Xoa", datetime.strptime("01/01/2000","%d/%m/%Y"))
